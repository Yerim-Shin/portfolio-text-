...
$(".header_main>ul>li:nth-child(2)").on("click", function () {
    ...
    ///typing
    const content = "안녕하세요, 육각형 디자이너 신예림입니다. \n 10년간 다양한 실무경험과 탄탄한 디자인이론을 바탕으로 디자인, 코딩, 기획, 마케팅, 영상, 브랜딩까지, \n육각형 디자이너로 거듭나기 위해 꾸준히 노력했습니다. \n 앞으로도 새로운걸 배우는데 두려워하지 않으며 더욱 큰 육각형을 그리는 디자이너가 되겠습니다!";
